...
contract Casino is ERC20Detailed, Owned {
    ...
    string constant tokenName = "Casino Token";
    string constant tokenSymbol = "Casino";
    ...
    */
    ...
    function findPercent(uint256 value) internal view returns (uint256)  {
        ...
        uint256 tenPecent = sellingValue.mul(flatPercent).div(10000);
        return  tenPecent;
    }
